...
class Customer76 {// class customer
    String name;                  
    String address;
    long phoneNo;
    Customer76 next;
    ...
    Customer76(String name, String address, long phoneNo, ArrayList<String> a, String ID) {
        this.name = name;
...
class Queue {// class queue
    ...
    void placeorder(Queue CID, Queue CORDER, Queue ALLORDER,Queue all) throws IOException {// places customer order - passing objects of array list
 	   ...
 	   Customer76 temp = new Customer76(CName, Address, PhoneNo, CORDER.A, ID);
        if (head == null) {
            head = temp;
            tail=temp;
        } else {
